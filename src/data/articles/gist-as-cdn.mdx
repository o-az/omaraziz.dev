...
This is apparently by [design](https://webapps.stackexchange.com/a/37100 'link'), `"text/plain"` MIME type effectively prevents from using gists as a CDN. Second attempt, adding it as a `<link>`:
