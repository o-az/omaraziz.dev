...
import postsInfo from '~posts/posts.json'

function filterArticles({ text, articles }: { text: string; articles: any[] }) {
...
const handleFiltering = (event: InputEvent | Event) => {
  ...
  return (
    <main class="m-6 mt-8 dark:text-white grid place-items-center justify-center">
      <div class="max-w-xl min-w-xl">
        ...
        <SearchBar onInputChange={handleFiltering} />
